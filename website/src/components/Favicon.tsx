...
const generateFavicon = (color: string | string[] = "#85c7a3", size: number = 16) => {
...
export default function Favicon({ color = "#85c7a3" }: FaviconProps) {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      [appleTouchIcon180, appleTouchIcon152, appleTouchIcon120, appleTouchIcon76].forEach(iconUrl => {
  ...
  }, [faviconDataUrl, appleTouchIcon180, appleTouchIcon152, appleTouchIcon120, appleTouchIcon76]);
